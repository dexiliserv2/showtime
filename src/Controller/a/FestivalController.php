...
//{
//    #[Route('/', name: 'app_festival', methods: ['GET'])]
//    public function index(FestivalRepository $bandRepository)//: Response
//    {
...
final class FestivalController extends AbstractController
{
    ...
    public function index(FestivalRepository $festRepository): Response
    {
        return $this->render('festival/index.html.twig', [
            'festivals' => $festRepository->findAll(),
        ]);
    }
